...
public class PartitionThroughputTest
{
    ...
    public static void RunTest(string fileName, Func<IPartitioner> partitionerFactory)
    {
        ...
        {
            string filePath = Path.Combine(outputDir, $"{fileName}_{i}.csv");
    ...
    {
        RunTest("ConcurrentOutputResults", () => new ConcurrentOutputPartitioner());
    }

    public static void IndependentOutputTest()
    {
        RunTest("IndependentOutputResults", () => new IndependentOutputPartitioner());
    }
